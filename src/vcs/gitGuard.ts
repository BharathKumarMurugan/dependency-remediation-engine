...
export class GitGuard {
  ...
  /**
   * Validates that the working tree is clean before running scanner operations
   */
  ...
  /**
   * Creates an atomic rollback snapshot before upgrading a single package.
   */
  ...
  /**
   * Confirms a successful package upgrade by discarding the temporary rollback snapshot stash.
   */
  ...
  /**
   * Rolls back ONLY the current package's modifications, restoring the repository to the state prior to this package's upgrade attempt.
   */
